        ...
        return function(i, o) {
            ...
            i = i || {}, a.schema = o = o || new e, i.fix_self_closing !== !1 && (i.fix_self_closing = !0), r("comment cdata text start end pi doctype".split(" "), function(e) {
                ...
                var s = this,
                    l, c = 0,
                    d, u, f = [],
                    p, m, h, g, v, y, b, C, x, w, _, N, E, k, S, T, R, A, B, H, L, M, D, P, O, I = 0,
                    F = t.decode,
                ...
                for (M = new RegExp("<(?:(?:!--([\\w\\W]*?)-->)|(?:!\\[CDATA\\[([\\w\\W]*?)\\]\\]>)|(?:!DOCTYPE([\\w\\W]*?)>)|(?:\\?([^\\s\\/<>]+) ?([\\w\\W]*?)[?/]>)|(?:\\/([^>]+)>)|(?:([A-Za-z0-9\\-\\:\\.]+)((?:\\s+[^\"'>]+(?:(?:\"[^\"]*\")|(?:'[^']*')|[^>]*))*|\\/|\\s+)>))", "g"), D = /([\w:\-]+)(?:\s*=\s*(?:(?:\"((?:[^\"])*)\")|(?:\'((?:[^\'])*)\')|([^>\s]+)))?/g, b = o.getShortEndedElements(), L = i.self_closing_elements || o.getSelfClosingElements(), C = o.getBoolAttrs(), w = i.validate, y = i.remove_internals, z = i.fix_self_closing, P = o.getSpecialElements(); l = M.exec(e);) {
                    if (c < l.index && s.text(F(e.substr(c, l.index - c))), d = l[6]) d = d.toLowerCase(), ":" === d.charAt(0) && (d = d.substr(1)), r(d);
                    else if (d = l[7]) {
                        ...
                        x || (k && k.indexOf("/") == k.length - 1 ? N && s.end(d) : f.push({
                            name: d,
                            valid: N
                        }))
        ...
        return function(t) {
            function r(r) {
                ...
                function p(t) {
                    ...
                    } else "BR" == t.nodeName ? t.nextSibling && i.isBlock(t.nextSibling) ? ((!A || 9 > A) && (d = i.create("br"), t.parentNode.insertBefore(d, t)), s.setStartBefore(t), s.setEndBefore(t)) : (s.setStartAfter(t), s.setEndAfter(t)) : (s.setStart(t, 0), s.setEnd(t, 0));
                ...
                function v(e, n) {
                    ...
                    if (o = i.getParent(e, i.isBlock), u = t.getBody().nodeName.toLowerCase(), !o || !d(o)) {
                        if (o = o || k, !o.hasChildNodes()) return r = i.create(f), m(r), o.appendChild(r), N.setStart(r, 0), N.setEnd(r, 0), r;
                        for (s = e; s.parentNode != o;) s = s.parentNode;
                        for (; s && !i.isBlock(s);) a = s, s = s.previousSibling;
                        if (a && l.isValidChild(u, f.toLowerCase())) {
                            for (r = i.create(f), m(r), a.parentNode.insertBefore(r, a), s = a; s && !i.isBlock(s);) c = s.nextSibling, r.appendChild(s), s = c;
                ...
                var N = o.getRng(!0),
                    E, k, S, T, R, A, B, H, L, M, D, P, O, I;
                if (!N.collapsed) return t.execCommand("Delete"), void 0;
                if (!r.isDefaultPrevented() && (S = N.startContainer, T = N.startOffset, O = (a.force_p_newlines ? "p" : "") || a.forced_root_block, O = O ? O.toUpperCase() : "", A = i.doc.documentMode, B = r.shiftKey, 1 == S.nodeType && S.hasChildNodes() && (I = T > S.childNodes.length - 1, S = S.childNodes[Math.min(T, S.childNodes.length - 1)] || S, T = I && 3 == S.nodeType ? S.nodeValue.length : 0), k = w(S))) {
                    if (s.beforeChange(), !i.isBlock(k) && k != i.getRoot()) return (!O || B) && C(), void 0;
                    if ((O && !B || !O && B) && (S = v(S, T)), R = i.getParent(S, i.isBlock), M = R ? i.getParent(R.parentNode, i.isBlock) : null, D = R ? R.nodeName.toUpperCase() : "", P = M ? M.nodeName.toUpperCase() : "", "LI" != P || r.ctrlKey || (R = M, D = P), "LI" == D) {
                        if (!O && B) return C(), void 0;
                        if (i.isEmpty(R)) return y(), void 0
                    }
                    if ("PRE" == D && a.br_in_pre !== !1) {
                        if (!B) return C(), void 0
                    } else if (!O && !B && "LI" != D || O && B) return C(), void 0;
                    O && R === t.getBody() || (O = O || "P", g() ? (H = /^(H[1-6]|PRE|FIGURE)$/.test(D) && "HGROUP" != P ? h(O) : h(), a.end_container_on_empty_block && d(M) && i.isEmpty(R) ? H = i.split(M, R) : i.insertAfter(H, R), p(H)) : g(!0) ? (H = R.parentNode.insertBefore(h(), R), u(H), p(R)) : (E = N.cloneRange(), E.setEndAfter(R), L = E.extractContents(), x(L), H = L.firstChild, i.insertAfter(L, R), f(H), _(R), p(H)), i.setAttrib(H, "id", ""), t.fire("NewBlock", {
                        newBlock: H
                    }), s.add())
                }
            }
        ...
        return function(n) {
            ...
            o(this, {
                ...
                mceInsertContent: function(t, r, i) {
                    ...
                    /^ | $/.test(i) && (i = o(i)), a = n.parser, s = new e({}, n.schema), v = '<span id="mce_marker" data-mce-type="bookmark">&#xFEFF;</span>', f = {
                        content: i,
                        format: "html",
                        selection: !0
                    }, n.fire("BeforeSetContent", f), i = f.content, -1 == i.indexOf("{$caret}") && (i += "{$caret}"), i = i.replace(/\{\$caret\}/, v);
                    var y = n.getBody();
                    ...
                    if (b.invalid) {
                        for (w.setContent(v), l = w.getNode(), c = n.getBody(), 9 == l.nodeType ? l = h = c : h = l; h !== c;) l = h, h = h.parentNode;
                    ...
                    } else i = s.serialize(u), h = l.firstChild, g = l.lastChild, !h || h === g && "BR" === h.nodeName ? x.setHTML(l, i) : w.setContent(i);
            ...
            function s(s) {
                ...
                c.on("init", function() {
                    ...
                    c.selection.lastFocusBookmark && (c.selection.setRng(a(c, c.selection.lastFocusBookmark)), c.selection.lastFocusBookmark = null), e != c && (e && e.fire("blur", {
                        ...
                        blurredEditor: e
                    }), c.focus(!1), r.focusedEditor = c), d = null
