...
class page_xProduction_page_owner_task_processing extends page_xProduction_page_owner_main{
	...
	function init(){
		...
		$crud=$left_col->add('CRUD',array('allow_add'=>false,'allow_edit'=>false,'allow_del'=>false,'allow_add'=>false,'allow_edit'=>false,'allow_del'=>false,'grid_class'=>'xProduction/Grid_Task'));
		$crud->setModel($mytask);
		$crud->manageAction('mark_processed');
		$crud->manageAction('reject_page');
