...
class Filter_Phrases extends \Filter_Base
{
    ...
    function init()
    {
        ...
        $this->type_field = $this->addField('Dropdown', 'category', '')->setEmptyText('All Subscription Category')->setNoSave()->setModel('xEnquiryNSubscription/Model_SubscriptionCategories');
    ...
    function postInit()
    {
        ...
        if($subcat)
	        $and->where('subscription_category_id',$subcat);
