...
class Filter_NewsLetter extends \Filter_Base
{
    ...
    function init()
    {
        ...
        $this->type_field = $this->addField('Dropdown', 'category', '')->setEmptyText('All NewsLetter Category')->setNoSave()->setModel('xEnquiryNSubscription/NewsLetterCategory');
