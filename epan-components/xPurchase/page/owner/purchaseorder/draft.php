...
class page_xPurchase_page_owner_purchaseorder_draft extends page_xPurchase_page_owner_main{
	...
	function page_index(){
		...
		$crud->setModel($draft_purchase_order_model,array('supplier_id','currency_id','priority','order_date','order_summary','orderitem_count','delivery_to'),array('name','supplier','order_date','orderitem_count'));
