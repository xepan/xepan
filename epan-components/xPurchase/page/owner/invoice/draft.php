...
class page_xPurchase_page_owner_invoice_draft extends page_xPurchase_page_owner_main{
	...
	function init(){
		...
		$crud->setModel($invoice_draft,array('supplier_id','termsandcondition_id','discount','billing_address','invoiceitem_count'),array('name','invoice_no','po','supplier','total_amount','tax','gross_amount','discount','net_amount','invoiceitem_count'));
