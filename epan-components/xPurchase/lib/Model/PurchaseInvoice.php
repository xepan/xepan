...
class Model_PurchaseInvoice extends \xShop\Model_Invoice{
	...
	public $notification_rules = array(
			...
			'submitted' => array(
							'xPurchase/Invoice_Submitted/can_approve'=>['title'=>'Purchase Invoice for Approval','message'=>'Purchase Invoice {$name} for Approval : [{$supplier}]'],
			...
			'redesign' => array('xPurchase/Invoice_Redesign/creator'=>['title'=>'Purchase Invoice Rejected','message'=>'Purchase Invoice {$name} is rejected by {$created_by} for Redesign']),
			'cancelled' => array('xPurchase/Invoice_Canceled/can_view'=>['title'=>'Purchase Invoice Canceled','message'=>'Purchase Invoice [{$name}] of [{$supplier}] is canceled by [{$created_by}]']),
			'completed' => array('xPurchase/Invoice_Completed/can_view'=>['title'=>'Purchase Invoice  Completed','message'=>'Purchase Invoice [{$name}] is Completed by {$created_by}']),
			'email' => array('xPurchase/Invoice_Approved/can_send_via_email'=>['title'=>'Purchase Invoice been Mailed','message'=>'Purchase Invoice [{$name}] is Mailed to [{$to} - {$email_to}] by {$created_by}']),
