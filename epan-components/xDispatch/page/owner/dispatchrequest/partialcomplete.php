...
class page_xDispatch_page_owner_dispatchrequest_partialcomplete extends page_xDispatch_page_owner_main{
	...
	function page_index(){
		...
		$crud->setModel('xDispatch/DispatchRequest_Processed',array('order_no','name','created_at','from_department','item_under_process','recent_items_to_receive','pending_items_to_deliver'));
