...
class page_xShop_page_owner_invoice_items extends page_xShop_page_owner_main{
	...
	function init(){
		...
		$item_crud->setModel($item_model,array('item_name','item_id','custom_fields','qty','rate','amount','custom_fields','apply_tax','narration'),array('item_name','item','qty','rate','amount','tax_per_sum','tax_amount','texted_amount','narration'));
