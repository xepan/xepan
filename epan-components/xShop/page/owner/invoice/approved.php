...
class page_xShop_page_owner_invoice_approved extends page_xShop_page_owner_main{
	function init(){
		...
		$crud->setModel($invoice_draft,array('customer_id','termsandcondition_id','discount','shipping_charge','billing_address','invoiceitem_count','created_at','narration'),array('name','customer','customer_id','sales_order','total_amount','tax','gross_amount','discount','net_amount','invoiceitem_count','shipping_charge','created_at','updated_at','updated_date','created_date'));
