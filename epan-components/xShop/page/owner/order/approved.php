...
class page_xShop_page_owner_order_approved extends page_xShop_page_owner_main{
	function init(){
		...
		$crud->setModel($approved_order,array('member_id','order_summary','termsandcondition_id','delivery_date'),array('name','created_at','member','net_amount','last_action','created_by','orderitem_count'));
