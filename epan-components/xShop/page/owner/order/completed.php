...
class page_xShop_page_owner_order_completed extends page_xShop_page_owner_main{
	function init(){
		...
		$crud->setModel('xShop/Model_Order_Completed',array('member_id','order_summary','termsandcondition_id'),array('name','created_at','member','net_amount','last_action','created_by','orderitem_count'));
