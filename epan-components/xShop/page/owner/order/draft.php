...
class page_xShop_page_owner_order_draft extends page_xShop_page_owner_main{
	function init(){
		...
		$this->add('PageHint')->set('Draft Orders are just your rough works. They are not considered in any of pipelines. Each ORderItem\'s Departmental status entry done with status "waiting" ');
