...
class page_xShop_page_owner_order_processed extends page_xShop_page_owner_main{
	function init(){
		...
		$crud->setModel('xShop/Model_Order_Processed',array('member_id','currency_id','order_summary','termsandcondition_id'),array('name','created_at','member','currency','net_amount','tax','gross_amount','discount_voucher_amount','total_amount','last_action','created_by','orderitem_count'));
