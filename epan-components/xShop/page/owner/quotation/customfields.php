...
class page_xShop_page_owner_quotation_customfields extends page_xShop_page_owner_main {
	...
	function init(){
		...
		$this->orderitem = $orderitem = $this->add('xShop/Model_QuotationItem')->addCondition('id',$orderitem_id)->tryLoadAny();
