...
class Plugins_epanCreated extends \componentBase\Plugin {
	...
	function Plugins_epanCreated($obj, $epan){
		$default_departments = array(
				...
				array('name'=>'Purchase','is_production_department'=>1,'related_application_namespace'=>'xStore','is_system'=>1,'jobcard_document'=>'xStore/Model_MaterialRequest','production_level'=>-2),
				...
				array('name'=>'Store','is_production_department'=>1,'related_application_namespace'=>'xStore','is_system'=>1,'jobcard_document'=>'xStore/Model_MaterialRequest','production_level'=>-1),
				array('name'=>'Dispatch And Delivery','is_production_department'=>1,'related_application_namespace'=>'xDispatch','is_system'=>1,'jobcard_document'=>'xDispatch/Model_DispatchRequest','production_level'=>100000),
			);
