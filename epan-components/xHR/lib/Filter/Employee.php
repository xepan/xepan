...
class Filter_Employee extends \Filter_Base
{
    ...
    function init()
    {
        ...
        $this->type_field = $this->addField('Dropdown', 'departments', '')->setEmptyText('All Departments')->setNoSave()->setModel('xHR/Department');
