<?php
class page_xHR_page_owner_config extends page_xProduction_page_owner_main{
	function init(){
		parent::init();
		...
		$tab = $dept_col->add('Tabs');
			$tab->addTabURL('xHR_page_owner_department_basic','Basic',array('department_id'));
			$tab->addTabURL('xHR_page_owner_department_attributes','Attributes',array('department_id'));
		}else{
