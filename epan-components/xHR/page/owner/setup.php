...
class page_xHR_page_owner_setup extends page_xHR_page_owner_main {
	function init(){
		...
		$tab = $this->add('Tabs');
			...
			$tab->addTabURL('xHR/page/owner/leavetype','Leave Type');
			$tab->addTabURL('xHR/page/owner/leavetype','Leave Allocation');
			$tab->addTabURL('xHR/page/owner/leavetype','Leave Block List');
			$tab->addTabURL('xHR/page/owner/leavetype','Employement Attendance');
	}
